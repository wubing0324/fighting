...
require([
...
], function(Slides, dom, contents, GUI, FizzyText, workshop) {
  ...
  _.each(contents, function(example, i) {
    ...
    var f = new FizzyText(initialText[i] || 'dat.gui', 800, 400, true, 160);
    f.maxSize *= 0.8;
    fizs.push(f);
